...
def normalize_text_for_tts(text: str) -> str:
    ...
    - Remueve puntos en separadores de miles (ej: '1.990' -> '1990', '45.990' -> '45990',
      '599.990' -> '599990', '1.069.990' -> '1069990')
      para que el motor fonético (espeak-ng/Kokoro) pronuncie números y precios en español
      de forma fluida y continua sin pausas extrañas.
    """
    if not text:
        return text
    # Eliminar puntos de miles en números (soporta múltiples agrupaciones de 3 dígitos)
